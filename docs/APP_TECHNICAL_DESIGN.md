...
| `AudioPlayerBar` | `ConsumerWidget` / 前後問題callback、`interactionEnabled` | audio State、settings Controller | seek、play、speed save、前後問題、3再生mode切り替え | 再生中・一時停止中は全操作を有効化。音源切り替えlock中だけ無効、Spinner非表示。Widget testあり |
